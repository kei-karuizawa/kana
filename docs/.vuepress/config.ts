/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/神流歌奈/vuepress-theme-vdoing/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "神流歌奈",
      description: '我的博客与知识库。',
    }
  },
  base: '/kana/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    // bodyBgImg: [
    //   'https://fastly.jsdelivr.net/gh/神流歌奈/image_store/blog/20200507175828.jpeg',
    //   'https://fastly.jsdelivr.net/gh/神流歌奈/image_store/blog/20200507175845.jpeg',
    //   'https://fastly.jsdelivr.net/gh/神流歌奈/image_store/blog/20200507175846.jpeg'
  ...
  head: [
    ['link', { rel: 'icon', href: 'https://ushio.oss-cn-shanghai.aliyuncs.com/kana/favicon.jpg' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
